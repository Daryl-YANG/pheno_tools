...
outDIR = '\\modex.bnl.gov\data2\dyang\projects\ngee_arctic\barrow\zpw\gcc_ts\2021\AMB_5B'
...
phenocamDIR = '\\modex.bnl.gov\data2\Projects\NGEEArctic\Data\Barrow\ZPW_Experiment\PhenoCam_data\2021_Data\AMB_5B'
...
roiDIR = '\\modex.bnl.gov\data2\dyang\projects\ngee_arctic\barrow\zpw\rois\2021'
; search all roi image files in roi folder
roiLIST = file_search(roiDIR, '*AMB_5B*'+fm_roi, count=numROI, /test_regular)
...
foreach rgb, rgbLIST do begin
  ...
  rgbEXIF = read_exif(rgb, thumb_image=thumb)
  rgbTIME = rgbEXIF.ifd0.Exif_Image_DateTime
